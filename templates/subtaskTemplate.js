/**
 * Generates HTML template for a subtask item.
 * Creates a subtask display with title and action buttons for edit and delete.
 *
 * @param {Object} subtask - The subtask object
 * @param {string} subtask.title - The title of the subtask
 * @param {number} index - The index position of the subtask in the array
 * @returns {string} HTML template string for the subtask item
 */
    ...
    return `
        <div ondblclick="editSubtask(${index})" class="subtask-item">
            ...
            <div class="subtask-actions">
                <button class="subtask-action-btn" type="button" onclick="editSubtask(${index})">
                    ${getEditSubtaskIcon()}
                </button>

                <button class="subtask-action-btn" type="button" onclick="deleteSubtask(${index})">
...
/**
 * Generates SVG icon for the edit action.
 *
 * @returns {string} SVG markup for the edit icon
 */
function getEditSubtaskIcon() {
    return `
...
/**
 * Generates SVG icon for the delete action.
 *
 * @returns {string} SVG markup for the delete icon
 */
function getDeleteSubtaskIcon() {
    return `
